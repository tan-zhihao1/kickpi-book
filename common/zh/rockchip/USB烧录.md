...
通用镜像烧录/批量烧录，如：`update-rk3576-kickpi-k7-android-multi-202505291812.img`。
...
[K1 / K1B /K3 / K8](../../../rk3576/zh/03-镜像烧录/01-获取镜像文件.md)
...
1. 使主板进入 MASKROM 烧录模式；[查看如何进入烧录模式](#burn_mode)
