...
time dd if=/mnt/media_rw/490D-CC9B/root/tmp1/new_file.img of=/dev/null bs=1M count=1024
time dd if=/dev/null of=/mnt/media_rw/490D-CC9B/root/tmp1/new_file.img bs=1M count=1024
```
