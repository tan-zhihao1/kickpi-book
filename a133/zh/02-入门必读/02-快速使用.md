...
默认系统适配7寸LVDS屏幕，如需切换其他屏幕显示的系统可参考[镜像烧录](https://tanzhs-private-organization.gitbook.io/kickpi-book/a133/zh/03-jing-xiang-shao-lu)，烧录对应显示的镜像。



[镜像烧录](..//03-jing-xiang-shao-lu)
