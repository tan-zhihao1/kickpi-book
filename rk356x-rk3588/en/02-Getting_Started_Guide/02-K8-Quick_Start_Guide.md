...
The K8 motherboard has display interfaces. You can check the number of interfaces and the default compatible display types in the [K8 Hardware Introduction](../01-Introduction to the Motherboard/05-KICKPI-K8 Hardware Introduction.md#display) section. You can connect display peripherals as needed.
...
MIPI 0 interface: [Flip-down FPC interface](../../../common/zh/display/FPC Interface Introduction#FPC-1)

![image-20250513145744893](http://tanzhtanzh.oss-cn-shenzhen.aliyuncs.com/img/image-20250513145744893.png)

MIPI 1 interface: [Pull-up FPC interface](../../../common/zh/display/FPC Interface Introduction#FPC-2)
...
The K8 Android/Debian system supports the use of ADB. For details, refer to the [ADB Tutorial](../../../common/zh/adb/ADB Tutorial.md).
