...
There are many free/commercial serial assistant tools, no need to use a special one, you can select which you prefer. Here we use Mobaxterm as an example:
