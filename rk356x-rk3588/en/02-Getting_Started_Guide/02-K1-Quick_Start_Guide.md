...
Each model of the motherboard is equipped with a DEBUG debug serial port, which is located in the 20PIN/40PIN pins section. You can locate the DEBUG port in the **Expansion Pins** section of the hardware introduction for each model of the motherboard in the motherboard introduction. Additionally, the location is marked with silkscreen on the front and back of the board.
