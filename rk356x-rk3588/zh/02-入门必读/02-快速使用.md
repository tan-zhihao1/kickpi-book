...
- 绿色 LED 是电源指示灯，上电后它会一直亮着。如果它不亮，那您就得检查一下电源部分是不是出问题了。
- 蓝色 LED 是系统工作心跳灯，上电后它会持续闪烁，这表示内核正在正常运行。要是它不闪烁，可能系统运行就不太正常啦。

绿色LED为电源指示灯，上电默认长亮。

蓝色LED为系统工作心跳灯，上电心跳灯持续闪烁，表示内核正常运行。
