...
```
kickpi-book/common/en/driver
kickpi-book/common/zh/driver
```

中文 [driver](../../../common/zh/driver/)
...
```
kickpi-book/common/en/driver/ADC
kickpi-book/common/zh/driver/ADC
```

[zh_ADC](../../../common/zh/driver/ADC.md)
...
```
kickpi-book/common/en/driver/CAMERA
kickpi-book/common/zh/driver/CAMERA
```
...
```
kickpi-book/common/en/driver/GPIO
kickpi-book/common/zh/driver/GPIO
```
...
```
kickpi-book/common/en/driver/Kernel
kickpi-book/common/zh/driver/Kernel
```
...
[kickpi-book/common/zh/driver/LCD](../../../common/zh/driver/GPIO.md)
...
[zh_GPIO](../../../common/zh/driver/GPIO.md)

## RTC

```
kickpi-book/common/en/driver/RTC
kickpi-book/common/zh/driver/RTC
```
...
```
kickpi-book/common/en/driver/UART
kickpi-book/common/zh/driver/UART
```

[zh_UART](../../../common/zh/driver/UART.md)
...
```
kickpi-book/common/en/driver/WIFI_BT
kickpi-book/common/zh/driver/WIFI_BT
```

[zh_WIFI_BT](../../../common/zh/driver/WIFI_BT.md)
