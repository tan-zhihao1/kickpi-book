...
echo normal > /sys/class/pwm/pwmchip0/export/pwm3/polarity 极性也可是"inversed"
echo 100000 > /sys/class/pwm/pwmchip0/export/pwm3/period 周期
echo 20000 > /sys/class/pwm/pwmchip0/export/pwm3/duty_cycle 占空比=duty_cycle/period
echo 1 > /sys/class/pwm/pwmchip0/export/pwm3/enable
```
