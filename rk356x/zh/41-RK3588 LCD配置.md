...
RK3588 有四个VP节点，每个VP节点可挂接一个显示屏，对应关系如下表格示
...
| 显示接口  | 显示最大分辨率 | 格式                          |
| --------- | -------------- | ----------------------------- |
| HDMI TX   | 7680x4320@60Hz | RGB, YCbCr 4:4:4, YCbCr 4:2:2 |
| eDP       | 4K@60Hz        | RGB 10Bit                     |
| DP TX     | 7680x4320@60Hz | RGB/YUV 10bit                 |
| MIPI DSI  | 4K@60Hz        | RGB 10Bit                     |
| Dual MIPI | 2560x1440@60Hz | RGB 10Bit                     |
|           |                |                               |
| BT.1120   | 1920x1080@60Hz | RGB 8Bit                      |
