...
| 显示接口 | 显示最大分辨率 | 协议标准                                       |
| -------- | -------------- | ---------------------------------------------- |
| RGB      | 1920x1080@60hz | BT.656/BT.1120                                 |
| MIPI     | 3840x2160@60hz | DSI v1.1，DCS v1.1， DPHY v2.0，<br/>CPHY V1.1 |
| eDP0     | 2560x1440@60Hz | DP1.2a 和 eDP1.3                               |
| HDMI     | 1280x800@60Hz  | HDMI 2.1                                       |
| DP       | 2560x1600@60Hz | DP1.4                                          |
...
$ vim kernel/arch/arm64/boot/dts/rockchip/rk3568-kickpi-k1.dtsi //android
