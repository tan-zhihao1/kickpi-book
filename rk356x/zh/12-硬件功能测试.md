...
调试串口内嵌到扩展40Pin引脚上，可通过扩展引脚章节 或下图查看调试串口位置
...
```
编码H.264 4096x2160 100帧测试 fps 44.65
编码H.265 4096x2160 100帧测试 fps 45.53
解码H.264 4096x2160 100帧测试 fps 206.22
解码H.265 4096x2160 100帧测试 fps 386.86
```
